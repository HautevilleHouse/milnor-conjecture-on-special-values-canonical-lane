...
mkdir -p .codex_tmp/milnor_conjecture_on_special_values
cp artifacts/stitch_constants.json .codex_tmp/milnor_conjecture_on_special_values/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/milnor_conjecture_on_special_values/constants_registry.json
python3 scripts/msv_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
