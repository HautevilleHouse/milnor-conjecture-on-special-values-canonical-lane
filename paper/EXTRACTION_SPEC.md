# Constant Extraction Spec (MSV)
    ...
    ## Formula Set
    - `kappa_polylog_raw = c_polylog_raw * polylog_density_raw - e_polylog_raw`
- `sigma_value_raw = value_floor_raw - regulator_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `regulator_transfer_raw = c_reg_raw * transfer_gain_raw - e_reg_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_polylog`, `sigma_value`, `kappa_compact`, `rho_rigidity`, `regulator_transfer`, `sigma_star_can`
    ...
    3. `scripts/msv_closure_guard.py`
